 ...
 * @author walker
 */
public class MyArrayListB <E>  implements Iterable<E>{
   ...
   private E myArray [];
    ...
    public void add(E e)
    {
       ...
       if (numStored == myArray.length)
          {
              /* the following code follows approach B in the lab */
    ...
    {
        MyArrayListB <Integer> intArr = new MyArrayListB <Integer>();
        MyArrayListB <String> strArr = new MyArrayListB <String>();
